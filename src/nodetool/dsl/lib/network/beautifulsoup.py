...
class BaseUrl(GraphNode):
    ...
    def get_node_type(cls):
        return "lib.network.beautifulsoup.BaseUrl"
...
class ExtractAudio(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.beautifulsoup.ExtractAudio"
...
class ExtractImages(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.beautifulsoup.ExtractImages"
...
class ExtractLinks(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.beautifulsoup.ExtractLinks"
...
class ExtractMetadata(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.beautifulsoup.ExtractMetadata"
...
class ExtractVideos(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.beautifulsoup.ExtractVideos"
...
class HTMLToText(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.beautifulsoup.HTMLToText"
...
class WebsiteContentExtractor(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.beautifulsoup.WebsiteContentExtractor"
