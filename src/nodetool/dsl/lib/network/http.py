...
class DeleteRequest(GraphNode):
    ...
    def get_node_type(cls):
        return "lib.network.http.DeleteRequest"
...
class DownloadDataframe(GraphNode):
    ...
    FileFormat: typing.ClassVar[type] = (
        nodetool.nodes.lib.network.http.DownloadDataframe.FileFormat
    )
    url: str | GraphNode | tuple[GraphNode, str] = Field(
        default="", description="The URL to make the request to."
    )
    file_format: nodetool.nodes.lib.network.http.DownloadDataframe.FileFormat = Field(
        default=nodetool.nodes.lib.network.http.DownloadDataframe.FileFormat.CSV,
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.http.DownloadDataframe"
...
class DownloadFiles(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.http.DownloadFiles"
...
class FetchPage(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.http.FetchPage"
...
class FilterValidURLs(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.http.FilterValidURLs"
...
class GetRequest(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.http.GetRequest"
...
class GetRequestBinary(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.http.GetRequestBinary"
...
class GetRequestDocument(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.http.GetRequestDocument"
...
class HeadRequest(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.http.HeadRequest"
...
class ImageDownloader(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.http.ImageDownloader"
...
class JSONGetRequest(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.http.JSONGetRequest"
...
class JSONPatchRequest(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.http.JSONPatchRequest"
...
class JSONPostRequest(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.http.JSONPostRequest"
...
class JSONPutRequest(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.http.JSONPutRequest"
...
class PostRequest(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.http.PostRequest"
...
class PostRequestBinary(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.http.PostRequestBinary"
...
class PutRequest(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.network.http.PutRequest"
