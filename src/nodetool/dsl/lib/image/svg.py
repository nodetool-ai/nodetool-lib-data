...
class DropShadow(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.svg.DropShadow"
...
class GaussianBlur(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.svg.GaussianBlur"
...
class Gradient(GraphNode):
    ...
    GradientType: typing.ClassVar[type] = (
        nodetool.nodes.lib.image.svg.Gradient.GradientType
    )
    gradient_type: nodetool.nodes.lib.image.svg.Gradient.GradientType = Field(
        default=nodetool.nodes.lib.image.svg.Gradient.GradientType.LINEAR,
...
class SVGToImage(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.svg.SVGToImage"
...
class Text(GraphNode):
    ...
    text_anchor: nodetool.nodes.lib.image.svg.SVGTextAnchor = Field(
        default=nodetool.nodes.lib.image.svg.SVGTextAnchor.START,
        description="Text anchor position",
    )

    @classmethod
    def get_node_type(cls):
        return "lib.image.svg.Text"
...
class Transform(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.svg.Transform"
