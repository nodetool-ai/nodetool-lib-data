...
class AdaptiveContrast(GraphNode):
    ...
    def get_node_type(cls):
        return "lib.image.pillow.enhance.AdaptiveContrast"
...
class AutoContrast(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.enhance.AutoContrast"
...
class Brightness(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.enhance.Brightness"
...
class Color(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.enhance.Color"
...
class Contrast(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.enhance.Contrast"
...
class Detail(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.enhance.Detail"
...
class EdgeEnhance(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.enhance.EdgeEnhance"
...
class Equalize(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.enhance.Equalize"
...
class RankFilter(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.enhance.RankFilter"
...
class Sharpen(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.enhance.Sharpen"
...
class Sharpness(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.enhance.Sharpness"
...
class UnsharpMask(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.enhance.UnsharpMask"
