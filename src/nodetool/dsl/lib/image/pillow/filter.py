...
class Blur(GraphNode):
    ...
    def get_node_type(cls):
        return "lib.image.pillow.filter.Blur"
...
class Canny(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.filter.Canny"
...
class Contour(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.filter.Contour"
...
class ConvertToGrayscale(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.filter.ConvertToGrayscale"
...
class Emboss(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.filter.Emboss"
...
class Expand(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.filter.Expand"
...
class FindEdges(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.filter.FindEdges"
...
class GetChannel(GraphNode):
    ...
    ChannelEnum: typing.ClassVar[type] = (
        nodetool.nodes.lib.image.pillow.filter.GetChannel.ChannelEnum
    )
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.ImageRef(type="image", uri="", asset_id=None, data=None),
        description="The image to get the channel from.",
    )
    channel: nodetool.nodes.lib.image.pillow.filter.GetChannel.ChannelEnum = Field(
        default=nodetool.nodes.lib.image.pillow.filter.GetChannel.ChannelEnum.RED,
        description=None,
    )

    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.filter.GetChannel"
...
class Invert(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.filter.Invert"
...
class Posterize(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.filter.Posterize"
...
class Smooth(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.filter.Smooth"
...
class Solarize(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.filter.Solarize"
