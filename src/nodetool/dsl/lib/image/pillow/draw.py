...
class Background(GraphNode):
    ...
    def get_node_type(cls):
        return "lib.image.pillow.draw.Background"
...
class GaussianNoise(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.draw.GaussianNoise"
...
class RenderText(GraphNode):
    ...
    TextFont: typing.ClassVar[type] = (
        nodetool.nodes.lib.image.pillow.draw.RenderText.TextFont
    )
    TextAlignment: typing.ClassVar[type] = (
        nodetool.nodes.lib.image.pillow.draw.RenderText.TextAlignment
    )
    text: str | GraphNode | tuple[GraphNode, str] = Field(
        default="", description="The text to render."
    )
    font: nodetool.nodes.lib.image.pillow.draw.RenderText.TextFont = Field(
        default=nodetool.nodes.lib.image.pillow.draw.RenderText.TextFont.DejaVuSans,
    ...
    align: nodetool.nodes.lib.image.pillow.draw.RenderText.TextAlignment = Field(
        default=nodetool.nodes.lib.image.pillow.draw.RenderText.TextAlignment.LEFT,
        description=None,
    )
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.image.pillow.draw.RenderText"
