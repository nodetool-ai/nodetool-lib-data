...
class AddHeading(GraphNode):
    ...
    def get_node_type(cls):
        return "lib.file.docx.AddHeading"
...
class AddPageBreak(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.file.docx.AddPageBreak"
...
class AddParagraph(GraphNode):
    ...
    ParagraphAlignment: typing.ClassVar[type] = (
        nodetool.nodes.lib.file.docx.ParagraphAlignment
    )
    document: types.DocumentRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.DocumentRef(type="document", uri="", asset_id=None, data=None),
    ...
    alignment: nodetool.nodes.lib.file.docx.ParagraphAlignment = Field(
        default=nodetool.nodes.lib.file.docx.ParagraphAlignment.LEFT,
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.file.docx.AddParagraph"
...
class CreateDocument(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.file.docx.CreateDocument"
...
class LoadWordDocument(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.file.docx.LoadWordDocument"
...
class SaveDocument(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.file.docx.SaveDocument"
...
class SetDocumentProperties(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.file.docx.SetDocumentProperties"
