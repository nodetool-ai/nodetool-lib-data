...
class ExtractMarkdown(GraphNode):
    ...
    def get_node_type(cls):
        return "lib.file.pymupdf.ExtractMarkdown"
...
class ExtractTables(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.file.pymupdf.ExtractTables"
...
class ExtractText(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.file.pymupdf.ExtractText"
...
class ExtractTextBlocks(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.file.pymupdf.ExtractTextBlocks"
...
class ExtractTextWithStyle(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.file.pymupdf.ExtractTextWithStyle"
