...
class AutoFitColumns(GraphNode):
    ...
    def get_node_type(cls):
        return "lib.file.excel.AutoFitColumns"
...
class CreateWorkbook(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.file.excel.CreateWorkbook"
...
class DataFrameToExcel(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.file.excel.DataFrameToExcel"
...
class ExcelToDataFrame(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.file.excel.ExcelToDataFrame"
...
class FormatCells(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.file.excel.FormatCells"
...
class SaveWorkbook(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.file.excel.SaveWorkbook"
