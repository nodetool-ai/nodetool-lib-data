...
class ExtractImages(GraphNode):
    ...
    def get_node_type(cls):
        return "lib.file.pdfplumber.ExtractImages"
...
class ExtractPageMetadata(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.file.pdfplumber.ExtractPageMetadata"
...
class ExtractTables(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.file.pdfplumber.ExtractTables"
...
class ExtractText(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.file.pdfplumber.ExtractText"
...
class GetPageCount(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.file.pdfplumber.GetPageCount"
